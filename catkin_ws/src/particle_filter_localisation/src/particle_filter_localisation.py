...
class ParticleFilter:
    ...
    def initialise_particles(self):
        ...
        for particle_ in range(self.num_particles_):
    ...
    def estimate_pose(self):
        ...
        ## pose of the particle with the highest weight
        # weighted_particle = 0
        # max_weight = 0
        # for p in self.particles_:
        ...
        # estimated_pose_x = weighted_particle.x
        # estimated_pose_y = weighted_particle.y
        # estimated_pose_theta = weighted_particle.theta
        #         
    ...
    def compass_fusion(self):
        ...
        # using complemetary method for fuse magnetometer data with existing orientation
        if self.motion_update_count_ >= self.num_motion_updates_:
            alpha = 0.8   # weight 
            for p in self.particles_:
